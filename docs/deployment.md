...
| Node.js          | Node 22, at least 22.12.0                          |
...
3. Review the repository and Worker names. Use `npm run build` as the build command and `npx wrangler deploy` as the deploy command; use Node 22.12+.
...
3. Set the build environment variable `NODE_VERSION=22`, then save and deploy.
...
| Platform | Setup                                                                                                                         |
| -------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Vercel   | Import the Git repository, select **Vite**, use the build settings above, and choose Node 22.x.                               |
| Netlify  | Import the Git repository, use the repository root as Base Directory, set the build/publish values above, and select Node 22. |
...
Current version of documents update on 2026-09-11.
